...
image_links = ["https://cdn.britannica.com/93/95393-050-5329EE11/planets-distance-order-Sun.jpg", 
"https://st.depositphotos.com/1007989/5151/i/600/depositphotos_51518159-stock-photo-boy-using-telescope.jpg",
"https://static.bhphotovideo.com/explora/sites/default/files/ts-space-sun-and-solar-viewing-facts-versus-fiction.jpg",
"https://starwalk.space/gallery/images/february-2020-three-planets-in-morning-sky/1024x576",
"https://c.tadst.com/gfx/600x337/march-equinox-dark.png",
"https://i.ytimg.com/vi/7E7zoFBwLU0/maxresdefault.jpg",
"https://media.gettyimages.com/photos/low-angle-view-of-sunrays-in-the-dark-picture-id660555985",
"https://cdn.mos.cms.futurecdn.net/LNAm66BstSr7n6HsLPN7Bk.jpg",
"https://media3.s-nbcnews.com/j/newscms/2018_45/2633521/181105-light-year-al-1550_70610a0a9146b249400f56ef30ec57d7.fit-2000w.jpg",
"https://c.tadst.com/gfx/600x337/waxing-crescent-moon.jpg"]
    ...
    try:
        ...
        if submit_clicked == True:
            if int(answers[qno]) == 1:
                       get_image(url="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/Green_tick.svg/1200px-Green_tick.svg.png",frame=questions_frame,r=10,c=1,height=20,width=30)
            if int(answers[qno]) == 2:
                       get_image(url="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/Green_tick.svg/1200px-Green_tick.svg.png",frame=questions_frame,r=11,c=1,height=20,width=30)
            if int(answers[qno]) == 3:
                       get_image(url="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/Green_tick.svg/1200px-Green_tick.svg.png",frame=questions_frame,r=12,c=1,height=20,width=30)
            if int(answers[qno]) == 4:
                       get_image(url="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/Green_tick.svg/1200px-Green_tick.svg.png",frame=questions_frame,r=13,c=1,height=20,width=30)
    except:
        if submit_clicked == True:
